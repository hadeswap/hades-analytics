      ...
      <PageHeader>
        <Box display="flex" alignItems="center" className={classes.pageHeader}>
          ...
          <Box display="flex" alignItems="center" className={classes.links}>
            <Link
              href={`https://hadesswap.finance/add/${pair.token0.id}/${pair.token1.id}`}
              target="_blank"
              variant="body1"
            ...
            <Link
              href={`https://hadesswap.finance/swap?inputCurrency=${pair.token0.id}&outputCurrency=${pair.token1.id}`}
              target="_blank"
              variant="body1"
            >
              Trade
      ...
      <Box my={4}>
        <BasicTable
          ...
          bodyCells={[
            ...
            <Link href={`https://explorer.polis.tech/address/${pair.id}`}>View</Link>,
          ]}
        />
      </Box>
      <Box my={4}>
